...
const api =
  "https://api.weatherapi.com/v1/current.json?key=cae4913bb6744fab83755352240805&q=";
...
searchButton.addEventListener("click", async (e) => {
  ...
  if (searchQuery.value !== "") {
    ...
    const weatherCardExists = e.target.parentNode.nextSibling;
    if (weatherCardExists) {
      weatherCardExists.remove();
    }
...
function createWeatherCard(weatherData) {
    ...
    const time = extractTime(weatherData.location.localtime);
